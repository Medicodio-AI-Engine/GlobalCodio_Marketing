...
// All upcoming events, soonest first - used by the /events page.
...
// The single soonest upcoming event - used by the home-page banner.
export async function getNextEvent() {
  return client.fetch(
    `*[_type == "event" && status == "upcoming"] | order(startDate asc)[0] { ${EVENT_PROJECTION} }`
  );
}
