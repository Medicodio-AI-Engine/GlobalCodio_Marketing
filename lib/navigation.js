...
/** On-domain mirrors of the two documents above. USCIS grades the privacy
 *  policy and terms it finds on the business website named in our Torch Case
 *  Status API affidavit (www.globalcodio.ai), so link these paths from anything
 *  a reviewer follows and keep the app.globalcodio.ai URLs above for the
 *  canonical-source references inside the documents themselves. */
export const PLATFORM_PRIVACY_PATH = '/platform-privacy';
export const PLATFORM_TERMS_PATH = '/platform-terms';
...
export const FOOTER_COLUMNS = [
  ...
  },
  {
    title: 'Legal',
    links: [
      { href: PLATFORM_PRIVACY_PATH, label: 'Platform Privacy Policy' },
      { href: PLATFORM_TERMS_PATH, label: 'Platform Terms of Service' },
