...
export const SITE_URL = process.env.NEXT_PUBLIC_SITE_URL || 'https://www.globalcodio.ai';
...
export const PLATFORM_URL = process.env.NEXT_PUBLIC_PLATFORM_URL || 'https://app.globalcodio.ai';
